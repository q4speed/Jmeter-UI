<template>
  <component-container :object="object"
    ...
    <component-field-set :title="t('wm.others.thread_group.thread')">
      <el-form-item :label="t('wm.others.thread_group.num_threads')" label-width="140px" prop="numThreads">
        <el-input type="number" v-model="object.numThreads.value"></el-input>
      </el-form-item>
      <el-form-item :label="t('wm.others.thread_group.ramp_time')" label-width="140px" prop="rampTime">
        <el-input type="number" v-model="object.rampTime.value"></el-input>
      </el-form-item>

      <el-form-item :label="t('wm.others.thread_group.loops')" label-width="140px" prop="loops">
      ...
      <el-form-item :label="t('wm.others.thread_group.duration')" label-width="140px" prop="duration">
        <el-input type="number" v-model="object.duration.value" :disabled="!object.scheduler.value"></el-input>
      </el-form-item>
      <el-form-item :label="t('wm.others.thread_group.delay')" label-width="140px" prop="delay">
