<template>
  <component-container :object="object"
    ...
    <component-field-set :title="t('wm.post_processors.jsr223_post_processor.script_set')">
      <el-form-item label-width="120px" prop="scriptLanguage">
      ...
      <el-form-item label-width="120px" prop="parameters">
        <template v-slot:label>
      ...
      <!--        <el-form-item :label="t('wm.post_processors.jsr223_post_processor.filename')" label-width="120px" prop="filename">-->
      <!--          <template v-slot:label>-->
      ...
      <el-form-item label-width="120px" prop="cacheKey">
        <template v-slot:label>
